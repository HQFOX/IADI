...
import pt.unl.fct.grantapp.service.UserService
import java.util.*
...
private fun addResponseToken(authentication: Authentication, response: HttpServletResponse) {
    ...
    claims["userid"] = customUser.getUserId()
...
class UserPasswordAuthenticationFilterToJWT (
    ...
    override fun attemptAuthentication(request: HttpServletRequest?,
        ...
        val user = jacksonObjectMapper().readValue(request!!.inputStream, UserPasswordDTO::class.java)
